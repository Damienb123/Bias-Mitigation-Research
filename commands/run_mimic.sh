...
data_dir="../${task}"
method_name=mimic-retrieve-def-${src}
train_file="hyperedges-mimic-text-train-${src}.jsonl"
valid_file="hyperedges-mimic-text-valid-${src}.jsonl"
test_file="hyperedges-mimic-text-test-${src}.jsonl"
lr=4e-5 # 2e-5
batch_size=32
epochs=4
weight_decay=1e-3
